...
from ProductSheetModel import ProductSheetModel
class FilterProcessModel:
    def __init__(self, product_spreadsheets: Dict[str, ProductSheetModel], payment_spreadsheet: str, payment_sheet_name: str):
